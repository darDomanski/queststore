...
public class Viewer {
    ...
    final String[] mentorMenu = {"Create Student,", "Add student to group", "Add new Item", "Devide Item into category",
    ...
    final String[] creepyMenu = {"Add new mentor", "Add mentor to group", "Edit mentor", "See mentor's profile"};
